...
public class TestRectButton3D {
    ...
    @Test
    public void testRectButton3D1() throws WindowException {
        Point topLeft = new Point(10, 20);
        Point bottomRight = new Point(30, 40);
        RectButton3D rectButton3D = new RectButton3D(topLeft, bottomRight, WindowState.INACTIVE, "OK", 10);
        assertAll(
                ...
                () -> assertEquals(WindowState.INACTIVE, rectButton3D.getState()),
    ...
    @Test
    public void testRectButton3D2() throws WindowException {
        Point topLeft = new Point(10, 20);
        Point bottomRight = new Point(30, 40);
        RectButton3D rectButton3D = new RectButton3D(topLeft, bottomRight, "INACTIVE", "OK", 10);
        assertAll(
                () -> assertEquals(10, rectButton3D.getTopLeft().getX()),
                () -> assertEquals(20, rectButton3D.getTopLeft().getY()),
                () -> assertEquals(30, rectButton3D.getBottomRight().getX()),
    ...
    @Test
    public void testRectButton3D3() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, WindowState.INACTIVE, "OK", 10);
        assertAll(
                () -> assertEquals(10, rectButton3D.getTopLeft().getX()),
                () -> assertEquals(20, rectButton3D.getTopLeft().getY()),
    ...
    @Test
    public void testRectButton3D4() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "INACTIVE", "OK", 10);
        assertAll(
                () -> assertEquals(10, rectButton3D.getTopLeft().getX()),
                () -> assertEquals(20, rectButton3D.getTopLeft().getY()),
                () -> assertEquals(39, rectButton3D.getBottomRight().getX()),
    ...
    @Test
    public void testRectButton3D5() throws WindowException {
        Point topLeft = new Point(10, 20);
        Point bottomRight = new Point(30, 40);
        ...
        assertAll(
                ...
                () -> assertEquals(21, rectButton3D.getWidth()),
                () -> assertEquals(21, rectButton3D.getHeight()),
                () -> assertEquals(WindowState.ACTIVE, rectButton3D.getState()),
                () -> assertEquals("OK", rectButton3D.getText()),
                () -> assertEquals(10, rectButton3D.getZHeight())
        );
    }
    ...
    @Test
    public void testRectButton3D6() throws WindowException {
    ...
    public void testState() throws WindowException {
        Window window = new RectButton3D(10, 20, 30, 40, "OK", 10);
    ...
    public void testWrongState() {
        ...
        try {
            Window window = new RectButton3D(10, 20, 30, 40, (WindowState) null, "OK", 10);
            failed = true;
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
        try {
            Window window = new RectButton3D(10, 20, 30, 40, (String) null, "OK", 10);
            failed = true;
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
        try {
            Window window = new RectButton3D(10, 20, 30, 40, "ENABLED", "OK", 10);
            failed = true;
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
        ...
        try {
            Window window = new RectButton3D(10, 20, 30, 40, WindowState.DESTROYED, "OK", 10);
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
            return;
        }
        try {
            Window window = new RectButton3D(10, 20, 30, 40, "DESTROYED", "OK", 10);
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
            return;
        }
    ...
    @Test
    public void testMoveToRectButton3D1() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
    ...
    @Test
    public void testMoveToRectButton3D2() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
    ...
    @Test
    public void testMoveRelRectButton3D() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
    ...
    @Test
    public void testResizeRectButton3D() throws WindowException {
    ...
    @Test
    public void testIsPointInsideRectButton3D1() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
        assertAll(
    ...
    @Test
    public void testIsPointInsideRectButton3D2() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
        assertAll(
    ...
    @Test
    public void testIsIntersectsRectButton3D() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
        assertAll(
    ...
    @Test
    public void testIsRectButtonInsideRectButton3D() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
        assertAll(
    ...
    @Test
    public void testIsRectButton3DInsideRectButton3D() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
        assertAll(
    ...
    @Test
    public void testRectButton3DsAreEqual() throws WindowException {
        RectButton3D rectButton3D1 = new RectButton3D(10, 20, 30, 40, "OK", 10);
        RectButton3D rectButton3D2 = new RectButton3D(10, 20, 30, 40, "OK", 10);
    ...
    @Test
    public void testRectButton3DSetText() throws WindowException {
        RectButton3D rectButton3D = new RectButton3D(10, 20, 30, 40, "OK", 10);
