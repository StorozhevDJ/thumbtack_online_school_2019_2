...
public class Server {
	...
	public String addRating(String jsonRequest) {
		...
		try {
			return new RatingService().addRating(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
	...
	public String changeRating(String jsonRequest) {
		...
		try {
			return new RatingService().changeRating(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
	...
	public String deleteRating(String jsonRequest) {
		...
		try {
			return new RatingService().deleteRating(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
	...
	public String addComment(String jsonRequest) {
		...
		try {
			return new CommentService().addComment(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
	...
	public String changeComment(String jsonRequest) {
		...
		try {
			return new CommentService().changeComment(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
	...
	public String disclaimComment(String jsonRequest) {
		...
		try {
			return new CommentService().disclaimComment(jsonRequest);
		} catch (ServerException e) {
			return jsonError(e);
		}
	}
