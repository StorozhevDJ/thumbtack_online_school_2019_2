package com.lineate.spring.models;
...
public class Recording {
    ...
    public Recording(String artist, String name, String albumName, int year, URL urlCover, String genre, int len, URL urlAudio, URL urlVideo) {
        this.artist = artist;
        this.name = name;
